	...
	<header id="header" class="header-transparent">
		<div class="container">
			...
			<nav id="nav-menu-container">
				<ul class="nav-menu">
					<li><a href="admin/dashboard"><b>Dashboard</b></a></li>
					<li><a href="admin/shops">Shop</a></li>
					<li><a href="admin/booked&Shop-Small">Bookings</a></li>
			...
			<table class="table1 table-bordered">
				...
				<tbody>
					...
					<c:forEach items="${cu}" var="u">
						<tr>
							<td onclick="window.location.href='admin/user=${u.id}'" class="td1">${u.id}</td>
							<td>${u.name}</td>
							<td>${u.email}</td>
							<td>${u.number}</td>
						</tr>
